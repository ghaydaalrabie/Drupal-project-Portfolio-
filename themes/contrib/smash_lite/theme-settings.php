...
/**
 * @file
 * Smash_lite theme file.
 */

/**
 * Smash lite form system theme settings alter.
 */
function smash_lite_form_system_theme_settings_alter(&$form, FormStateInterface $form_state, $form_id = NULL) {
  if ($form['#attributes']['class'][0] == 'system-theme-settings') {
    $form['#attached']['library'][] = 'smash_lite/theme.setting';
    $options_theme = [
      'left' => 'Left Side',
      'right' => 'Right Side',
    ];
    ...
    $form['banner']['slideshow']['slideshow_display'] = [
      ...
      '#default_value' => theme_get_setting('slideshow_display', 'smash_lite'),
    ...
    for ($i = 1; $i <= 3; $i++) {
      ...
      $form['banner']['slideshow']['slide' . $i]['slide' . $i . '_head'] = [
        ...
        '#default_value' => theme_get_setting('slide' . $i . '_head', 'smash_lite'),
      ];
      $form['banner']['slideshow']['slide' . $i]['slide' . $i . '_desc'] = [
        '#type' => 'textarea',
        '#title' => t('Slide Description'),
        '#default_value' => theme_get_setting('slide' . $i . '_desc', 'smash_lite'),
      ];
      $form['banner']['slideshow']['slide' . $i]['slide' . $i . '_url'] = [
        '#type' => 'textfield',
        '#title' => t('Slide URL'),
        '#default_value' => theme_get_setting('slide' . $i . '_url', 'smash_lite'),
      ];
      $form['banner']['slideshow']['slide' . $i]['slide' . $i . '_link_text'] = [
        '#type' => 'textfield',
        '#title' => t('Link Text'),
        '#default_value' => theme_get_setting('slide' . $i . '_link_text', 'smash_lite'),
      ];
    ...
    $form['show_header_image_details']['header_details']['header_image'] = [
      '#type' => 'managed_file',
      '#title' => t('Header image'),
      '#default_value' => theme_get_setting('header_image', 'smash_lite'),
    ...
    $form['show_footer_first_details']['footer_details']['footer_image'] = [
      ...
      '#default_value' => theme_get_setting('footer_image', 'smash_lite'),
      '#upload_location' => 'public://',
      '#upload_validators' => [
    ...
    $form['#submit'][] = 'smash_lite_settings_form_submit';
    $theme = \Drupal::theme()->getActiveTheme()->getName();
    $theme_file = drupal_get_path('theme', $theme) . '/smash_lite.theme';
